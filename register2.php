...
// } 
	...
	$stmt = $pdo->prepare('INSERT INTO accounts (username, password, email, activation_code,leftORright,user_id,status,first_name,last_name) VALUES (?, ?, ?, ?, ?, ?,?,?,?)');
	...
	$stmt->execute([ $_POST['username'], $password, $_POST['email'], $uniqid,$leftORright, $user_id,$status,$first_name,$last_name ]);
