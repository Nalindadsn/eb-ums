...
$username = $password = $confirm_password = $email= $status = $first_name = $last_name= "";
$username_err = $password_err=$status_err = $confirm_password_err  = $email_err= $first_name_err = $last_name_err="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err) && empty($first_name_err)  && empty($last_name_err)){
        ...
        $sql = "INSERT INTO accounts (username,email, password,status,first_name,last_name,activation_code,role) VALUES (:username,:email, :password,:status,:first_name,:last_name,:activation_code,:role)";
        ...
        if($stmt = $pdo->prepare($sql)){
            ...
            if($stmt->execute()){
                ...
                header('location: admin/users.php?st=new&id='.trim($_POST['username']));
            } else{
                echo "Oops! Something went wrong. Please try again later.";
            }
...
<div  class="container-fluid">
  ...
  <div class="row " style="background:url('img/imgbg.jpg');background-size: cover;min-height: 100vh;">
...
<img src="dist/img/logoceb.png" style="width: 50%;">

      </a>
    </div>
    <div class="card-body register">

      <h3 class="login-box-msg"> Register an Admin </h3>
