      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <select  name="cat_id" id="cat_id" class="form-control" >
            ...
            <option value="MC">Meter Changing</option>
            <option value="WL">Waylevel</option>
            <option value="LS">Line Shifting</option>
            <option value="PS">Pole Shifting</option>
            <option value="PB">Pole Breackdown</option>
            <option value="SW">Service Wayer</option>
            <option value="CU">Cutouts</option>
            <option value="MB">Meter Box</option>
